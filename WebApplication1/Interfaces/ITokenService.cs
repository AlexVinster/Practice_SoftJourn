...
namespace WebApplication1.Interfaces
{
    public interface ITokenService
    {
        ...
        Task<Token> UpdateTokenAsync(int tokenId, string name, string symbol, decimal totalSupply, decimal exchangeRateToDollars);
        ...
        Task<Token> CreateTokenAsync(string name, string symbol, decimal totalSupply, decimal exchangeRateToDollars);
